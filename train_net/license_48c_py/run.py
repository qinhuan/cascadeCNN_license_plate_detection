...
def training(device_id=0):
    ...
    pos_list = []
    neg_list = []
    pos_file = '/home/work/qinhuan/mywork/license_plate/data/data_list/all_pos48c_resize24x72.txt'
    neg_file = '/home/work/qinhuan/mywork/license_plate/data/data_list/all_neg48c_resize24x72.txt'
    f = open(pos_file, 'r')
    ...
    transformer.set_mean('data', np.array([115, 98, 83]))
