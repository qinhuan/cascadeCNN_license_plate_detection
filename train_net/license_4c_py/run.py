...
import numpy as np
import math
import license_4_net as Net 
import random
import cv2

data_dir = '/home/work/qinhuan/mywork/license_plate/data/lmdb'
train_lmdb = os.path.join(data_dir, 'license_train_4c_lmdb')
test_lmdb = os.path.join(data_dir, 'license_val_4c_lmdb')
mean_file = os.path.join(data_dir, 'license_train_4c_imagenet_mean.binaryproto')
debug_iter = 2500
mbox_loss = []
x = []
...
def training(device_id=0):
    ...
    pos_list = []
    neg_list = []
    pos_file = '/home/work/qinhuan/mywork/license_plate/data/data_list/all_pos_resize4x12.txt'
    neg_file = '/home/work/qinhuan/mywork/license_plate/data/data_list/all_neg_resize4x12.txt'
    f = open(pos_file, 'r')
