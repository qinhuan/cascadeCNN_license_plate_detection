...
import numpy as np
import math
import license_48cal_net as Net 

data_dir = '/home/work/qinhuan/mywork/license_plate/data/lmdb'
train_lmdb = os.path.join(data_dir, 'license_train_24cal_lmdb')
test_lmdb = os.path.join(data_dir, 'license_val_24cal_lmdb')
mean_file = os.path.join(data_dir, 'license_train_24cal_imagenet_mean.binaryproto')
debug_iter = 2500
mbox_loss = []
x = []

#num_test_image = len([l for l in open(name_size_file, 'r').readlines()]) 
job_name = 'license_48cal'
