...
def training(device_id=0):
    ...
    neg_file = '/home/work/qinhuan/mywork/license_plate/data/data_list/all_neg_resize12x36.txt'
    f = open(pos_file, 'r')
    ...
    transformer.set_mean('data', np.array([57,59,57]))
