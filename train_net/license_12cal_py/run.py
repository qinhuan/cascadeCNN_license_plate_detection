...
import numpy as np
import math
import license_12cal_net as Net 

data_dir = '/home/work/qinhuan/mywork/license_plate/data/lmdb'
train_lmdb = os.path.join(data_dir, 'license_train_12cal_lmdb')
test_lmdb = os.path.join(data_dir, 'license_val_12cal_lmdb')
mean_file = os.path.join(data_dir, 'license_train_12cal_imagenet_mean.binaryproto')
debug_iter = 2500
mbox_loss = []
x = []

#num_test_image = len([l for l in open(name_size_file, 'r').readlines()]) 
job_name = 'license_12cal'
